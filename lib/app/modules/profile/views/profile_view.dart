...
class ProfileView extends GetView<ProfileController> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: Obx(() {
          if (controller.profileState.value.isLoading) {
            return const Center(
                      ...
                      child: TextButton(
                          onPressed: () {
                            AwesomeDialog(
                              ...
                              btnCancelText: "BATAL",
                              btnCancelColor: tPrimaryColor,
                              btnCancelOnPress: () {},
                              btnOkText: controller.profileState.value.isLoading
                                  ? "Loading..."
                                  : "KELUAR",
                              btnOkOnPress:
                                  controller.profileState.value.isLoading
                                      ? null
                                      : () {
                                          controller.logout();
                                          if (controller
